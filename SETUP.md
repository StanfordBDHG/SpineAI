...
This will take 5-10 minutes as Docker downloads and starts all services.

You'll see lots of text scrolling - this is normal. Wait until you see "Started" messages and the command prompt returns.
